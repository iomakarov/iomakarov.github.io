...
$img = "z_e8d47703.jpg";
//
$gen = new GeneratorImageColorPalette();
$colors  = $gen->getImageColor('./../static/decor/'.$img,5,10);

?><div><img src="/static/decor/<?=$img?>" style="width:300px;height:300px;" /></div><?
foreach ($colors as $color => $value)
{
?>
    <div style="width:50px;height:50px;background-color:#<?=$color?>;"><?=$color?></div>
<?
}
?>