...
"&amp;bufferColor=" + settings.bufferColor;
    ...
    function playTrack(el, id) {
        ...
        $.each($(el).find(".drplayer-btn"), function() {
    ...
    function pause(el) {
        $(el).each(function() {
            var id = $(this).data("id");
			el.find(".current").find(".drplayer-btn").removeClass("play").removeClass("pause").addClass("play");
    ...
    function resume(el) {
        $(el).each(function() {
			...
			el.find(".current").find(".drplayer-btn").removeClass("play").removeClass("pause").addClass("pause");
    ...
    function stop(el) {
        $.each($(el).find(".item"), function() {
            ...
            $.each($(this).find(".drplayer-btn"), function() {
                $(this).removeClass("pause").addClass("play");
            });
        });
    }
		...
		playerurl	     : "drplayer.swf"    
            ...
            return this.each(function() {
                ...
                $.each($(el).find(".item"), function() {
                    ...
                    $(this).find(".drplayer-btn").click(function() {
